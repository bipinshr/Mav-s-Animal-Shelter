...
public class MainWin extends JFrame{
	...
	private JLabel data;
	enum DataView{ANIMALS,CLIENTS,ADOPIONS};
	...
	private void updateDisplay(DataView view){
		...
		else if(view.equals(DataView.CLIENTS))
		{
			data.setText("<html>"+shelter.clientToString().replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br/>")+"</html>");
		}
		else
		{
			data.setText("<html>"+shelter.adoptionsToString().replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br/>")+"</html>");
		}
	}
